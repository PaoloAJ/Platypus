...
const SITE_DEFAULTS = {
  ...
  scarcity: { eyebrow: "", headline: "", body: "", disclaimer: "" },
  serviceArea: {
    eyebrow: "",
    headline: "",
    description: "",
...
const CMSContext = createContext({
  projectsData: [],
  servicesData: { homepage: [], categories: [] },
  testimonialsData: [],
  siteData: SITE_DEFAULTS,
});

const mergeSite = (raw) => ({
  ...SITE_DEFAULTS,
  ...raw,
  hero: { ...SITE_DEFAULTS.hero, ...(raw?.hero ?? {}) },
  socialProof: { ...SITE_DEFAULTS.socialProof, ...(raw?.socialProof ?? {}) },
  beforeAfter: { ...SITE_DEFAULTS.beforeAfter, ...(raw?.beforeAfter ?? {}) },
  process: { ...SITE_DEFAULTS.process, ...(raw?.process ?? {}) },
  testimonialsSection: {
    ...SITE_DEFAULTS.testimonialsSection,
    ...(raw?.testimonialsSection ?? {}),
  },
  scarcity: { ...SITE_DEFAULTS.scarcity, ...(raw?.scarcity ?? {}) },
  serviceArea: { ...SITE_DEFAULTS.serviceArea, ...(raw?.serviceArea ?? {}) },
});

const useCMS = () => useContext(CMSContext);
const useProjects = () => useCMS().projectsData;
const useServicesData = () => useCMS().servicesData;
const useTestimonials = () => useCMS().testimonialsData;
const useSite = () => useCMS().siteData;
...
import { PROCESS_ICONS, SERVICE_ICONS } from "@/lib/registries";
...
function Hero() {
  ...
  return (
    <section className="relative pt-32 sm:pt-36 lg:pt-44 pb-16 sm:pb-20 lg:pb-28 overflow-hidden">
        ...
        <div className="mt-5 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
          ...
          <FadeRise delay={180}>
            <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/70 to-transparent">
                    <div className="flex items-center justify-between text-[12px]">
                      <div className="flex items-center gap-2 text-[#EDEDED]">
                        ...
                        {siteData.hero.demoCaption}
                      </div>
                      <div className="text-[#9CA3AF]">
                        {siteData.hero.demoLocation}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {siteData.hero.avgTimelineValue && (
...
function SocialProof() {
  const { socialProof } = useSite();
  const target = Number.parseInt(socialProof.count, 10) || 0;
  ...
  const towns = socialProof.towns ?? [];
  const publications = socialProof.publications ?? [];
...
function CroppedImage({ src, focalX = 50, focalY = 50, zoom = 1, alt = "" }) {
  const resolved = src || "/placeholders/before-after.svg";
  return (
    <Image
      src={resolved}
      alt={alt}
          ...
          <div className="flex items-end justify-between flex-wrap gap-4 mb-12">
            <div>
              ...
              <h2 className="h2 mt-3 max-w-xl text-white">
                {beforeAfter.headlinePart1}{" "}
                <span className="text-[#9CA3AF]">{beforeAfter.headlinePart2}</span>
              </h2>
            </div>
...
function Process() {
  ...
  return (
    <section
      id="process"
      className="py-16 sm:py-20 lg:py-28 relative border-y border-[#1F2937]/60"
      style={{
        background:
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <FadeRise>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="h2 mt-3 text-white">{process.headline}</h2>
            <p className="body-lg text-[#9CA3AF] mt-5">{process.description}</p>
          </div>
        </FadeRise>
        <div className="mt-14 relative">
          ...
          <div className="grid lg:grid-cols-4 gap-8 lg:gap-6">
            {steps.map((s, i) => {
              const Icon = PROCESS_ICONS[s.icon] || ClipboardList;
              return (
                <FadeRise key={i} delay={i * 80}>
...
function Services() {
  ...
  if (servicesData.homepage.length === 0) return null;
  const services = servicesData.homepage.map((s) => ({
    ...s,
  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 justify-center mx-auto">
...
function Testimonials() {
  ...
  const { testimonialsSection: t } = useSite();
  if (reviews.length === 0) return null;

  return (
    <section id="reviews" className="py-16 sm:py-20 lg:py-28 relative">
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <FadeRise>
          <div className="flex flex-col items-center text-center mb-12">
            <Eyebrow>{t.eyebrow}</Eyebrow>
            <h2 className="h2 mt-3 max-w-2xl text-white">
              {t.headlinePart1} {t.rating} out of {t.ratingMax} across{" "}
              {t.reviewCount} {t.headlinePart2}
            </h2>
            <div className="mt-5 flex items-center gap-3">
              ...
              <span className="text-[#9CA3AF]">/ {t.ratingMax}</span>
...
function Scarcity() {
  ...
  return (
    <section id="quote" className="py-16 sm:py-20 lg:py-32 relative overflow-hidden">
      <div className="absolute inset-0 glow-cyan pointer-events-none" />
      <div className="max-w-6xl mx-auto px-5 sm:px-6 relative">
        <div
          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center relative">
            <div>
              ...
              <FadeRise delay={120}>
                <div className="mt-7 max-w-md">
                  <Link
                    href="/contact"
                    className="btn-cyan rounded-xl px-6 py-4 font-semibold inline-flex items-center justify-center gap-2 w-full text-center"
                  >
            ...
            <FadeRise delay={120}>
              <Link href="/contact" className="block group">
                <div className="rounded-2xl bg-[#0B132B]/70 border border-[#1F2937] p-5 transition-colors group-hover:border-[#00BCD4]/40">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-[12px] text-[#7DD3FC] font-semibold inline-flex items-center gap-1 group-hover:text-[#00BCD4] transition-colors">
...
function ServiceArea() {
  const { serviceArea } = useSite();
  return (
    <section className="py-16 sm:py-20 lg:py-24 border-t border-[#1F2937]/60">
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10">
          <FadeRise>
            <div>
              <Eyebrow>{serviceArea.eyebrow}</Eyebrow>
              <h3
